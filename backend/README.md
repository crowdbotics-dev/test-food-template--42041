...
## Project Structure
    ...
    ├── test_food_template__42041  # Django project configurations
...
1. Clone this repo and `cd test_food_template__42041`
...
2. Clone this repo and `cd test_food_template__42041`
